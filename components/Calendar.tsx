...
const Calendar = ({ value, setValue, text }: Props): JSX.Element => {
	...
	return (
		<>
			<div className="w-full">
				<div className="calendar-container">
					<div className="header">
						<p>{text}</p>
						<AiOutlineCaretDown className="text-pink rotate-180" />
					</div>
			...
			.calendar-container {
				border-width: 1px;
				border-color: rgba(255, 88, 151, 1);
